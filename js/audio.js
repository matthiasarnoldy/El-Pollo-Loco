class AudioManager {
    ...
    sounds = {
        ...
        "enemy.chicken.walk": { src: "assets/sounds/chicken.mp3", volume: 0.45 },
        "enemy.chicken_small.walk": { src: "assets/sounds/chicken_small.mp3", volume: 0.16 },
    ...
    play(key, options = {}) {
        ...
        sound.addEventListener("ended", () => this.removeActiveSound(sound));
